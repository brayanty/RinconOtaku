...
function Settings () {
  return (
    <div className="absolute top-0 bottom-0 right-0 left-0 group select-none w-[250px] flex flex-col p-4 items-center justify-center bg-gray-800 border border-gray-800 shadow-lg rounded-2xl">
      <div className>
